...
module.exports = {
    run : function(creep) {
	    ...
	    if (creep.memory.a) {
	        var broken = creep.pos.findInRange(FIND_STRUCTURES, 2, {filter: (e) => ((e.structureType == STRUCTURE_STORAGE && e.my) || e.structureType == STRUCTURE_CONTAINER) && e.hits < e.hitsMax});
