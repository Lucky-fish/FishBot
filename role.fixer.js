...
module.exports = {
    run : function(creep) {
	    ...
	    if (creep.memory.a) {
			const broken = creep.room.find(FIND_STRUCTURES, {filter: (e) => (e.hits < e.hitsMax && (e.structureType === STRUCTURE_WALL || e.my)) || (e.structureType === STRUCTURE_ROAD) || (e.structureType === STRUCTURE_RAMPART)});
